            ...
            <Container className="container d-flex justify-content-center align-items-center">
                ...
                <Card.Body>
                    ...
                    <Form.Group controlId="email">
                            ...
                            <Form.Control type="email" placeholder="Enter Email" value={this.state.email} onChange={ev => this.setState({email: ev.target.value})} 
                            autoComplete="false" />
                        </Form.Group>
                    ...
                    </Form><Link to='/login'> Already have account </Link>
                </Card.Body>
                </Card>
            </Container>
        )
